...
<main class="mx-auto max-w-3xl px-2 sm:px-6 lg:px-8 py-8 min-h-screen bg-gradient-to-tr from-somasteel-orange/10 via-white to-gray-50 flex flex-col">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-extrabold tracking-tight text-somasteel-orange flex items-center gap-2 animate-fade-in">
            <i class="fa fa-plus-circle text-somasteel-orange"></i>
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl p-8 border-l-4 border-somasteel-orange animate-slide-in mt-0 overflow-hidden">
        <form method="POST" action="{{ route('purchase.suppliers.store') }}" class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
            @csrf
...
<input type="text" name="company_name" id="company_name" required value="{{ old('company_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg font-bold text-gray-900">
...
<input type="text" name="contact_first_name" id="contact_first_name" required value="{{ old('contact_first_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-900">
...
<input type="text" name="contact_last_name" id="contact_last_name" required value="{{ old('contact_last_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-900">
...
<input type="email" name="contact_email" id="contact_email" value="{{ old('contact_email') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-800">
...
<input type="text" name="contact_phone" id="contact_phone" inputmode="numeric" minlength="10" value="{{ old('contact_phone') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-800">
...
<input type="text" name="city" id="city" value="{{ old('city') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-800">
...
<input type="text" name="country" id="country" value="{{ old('country') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-somasteel-orange focus:ring focus:ring-somasteel-orange/30 text-lg text-gray-800">
