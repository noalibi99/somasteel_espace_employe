...
<div class="container mx-auto py-6">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="flex flex-col md:flex-row md:items-center justify-between px-4 py-3 border-b border-gray-200">
            @if (Auth::user()->isRH())
            <div class="relative w-60 m-4 ml-2">
    ...
    <div class="relative">
        ...
        <ul class="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-xl z-20 hidden py-2" id="settingsDropdown">
            <li>
    ...
    <form action="{{ route('absenceDec.index') }}" method="GET" class="flex items-center space-x-2 bg-white rounded-lg shadow px-3 py-2">
        ...
        <button class="bg-orange-500 text-white px-4 py-1.5 rounded-md hover:bg-orange-600 transition text-sm font-semibold shadow"
            ...
            <div class="inline-flex rounded-lg bg-orange-500 p-1" id="shiftTabs" role="group">
    <button type="button"
        class="shift-btn px-4 py-2 rounded-lg font-bold transition
