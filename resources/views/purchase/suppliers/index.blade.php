                                ...
                                <div class="flex gap-1">
                                    ...
                                    <a 
                                        ...
                                        class="inline-flex items-center justify-center w-8 h-8 rounded-full 
                                            @can('update', $supplier) bg-gray-100 hover:bg-green-100 text-green-600 @else bg-gray-200 text-gray-400 cursor-not-allowed @endcan"
                                    ...
                                    <form action="{{ route('purchase.suppliers.destroy', $supplier->id) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                                class="inline-flex items-center justify-center w-8 h-8 rounded-full @can('delete', $supplier) text-red-600 hover:bg-red-100 bg-gray-100 @else cursor-not-allowed disabled text-gray-400 bg-gray-200 @endcan"
                                                title="@can('delete', $supplier) Supprimer @else Non autorisé @endcan"
                                                @cannot('delete', $supplier) disabled @endcannot>
